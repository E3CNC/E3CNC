  ...
  <v-row>
    ...
    <v-col cols="12" md="4">
      <v-card>
        ...
        <v-card-actions class="justify-center pb-4">
          <v-btn to="/instances" variant="outlined" color="primary" size="small">
            View Instances
          </v-btn>
        </v-card-actions>
      </v-card>
    ...
    <v-col cols="12" md="4">
      <v-card>
        ...
        <v-card-actions class="justify-center pb-4">
          <v-btn to="/releases" variant="outlined" color="primary" size="small">
            View Releases
          </v-btn>
        </v-card-actions>
      </v-card>
        ...
        <v-table v-else>
          ...
          <tbody>
            <tr v-for="inst in instances" :key="inst.name">
              ...
              <td><code>{{ inst.moonraker_port }}</code></td>
              <td>
