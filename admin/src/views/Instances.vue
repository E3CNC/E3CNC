<template>
    <v-card>
        <v-card-title class="d-flex align-center">
            ...
            All Instances
            <v-spacer />
            <v-btn size="small" variant="outlined" color="primary" :loading="loading" @click="loadData">
        ...
        <v-expansion-panels v-else variant="accordion">
            <v-expansion-panel v-for="inst in instances" :key="inst.name">
                        ...
                        <div class="d-flex align-center ga-3 w-100">
                            ...
                            <div>
                                ...
                                <div class="text-caption text-medium-emphasis">
                                    Moonraker :{{ inst.moonraker_port }} &middot; Web :{{ inst.web_port }}
                                </div>
                            </div>
                            <v-spacer />
                            <v-chip :color="allPassed(inst) ? 'success' : 'warning'" size="x-small" variant="tonal">
                                {{ healthSummary(inst) }}
                            </v-chip>
                        </div>
                    </template>
