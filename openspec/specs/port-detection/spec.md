...
Define port detection behavior for the installer. The installer SHALL use `net.Listen` to detect available ports for Admin UI (8081), Moonraker (7125), and Klipper (7126), scanning upward when ports are in use.
