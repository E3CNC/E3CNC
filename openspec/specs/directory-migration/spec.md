...
Migrate the E3CNC install directory from `~/e3cnc` (lowercase) to `~/E3CNC` (uppercase) to standardize naming. The migration MUST be non-destructive and handle edge cases like symlinks, merge conflicts, and partial states.
