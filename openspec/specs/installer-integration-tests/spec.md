...
Define the integration test suite for the installer, running inside a Debian 12 Docker container. Tests cover all installer subsystems: port detection, directory migration, smart backup, package installation, configuration, and binary download.
