...
Define the pre-installation backup strategy for the E3CNC installer. Backups preserve user data (instances/, logs/), exclude non-user content (releases/, admin/, backups/), and are pruned to a maximum of 5 backups.
