...
| --------- | :--: | ------- | ----------------------------------------------- | --- |
| `refresh` | bool | false   | _DEPRECATED_. When `true` an attempt will       |
...
_Deprecated in API Version 1.5.0, superseded by the_
_[Upgrade](#perform-an-upgrade) endpoint._
