...
#### _ConfigHelper.getint(option_name, default=Sentinel)_

Returns the value of the option`option_name` as an integer. If
the option does not exist, returns `default`. If `default` is
not provided raises a `ConfigError`.

#### _ConfigHelper.getfloat(option_name, default=Sentinel)_

Returns the value of the option`option_name` as a float. If
the option does not exist, returns `default`. If `default` is
not provided raises a `ConfigError`.

#### _ConfigHelper.getboolean(option_name, default=Sentinel)_

Returns the value of the option`option_name` as a boolean. If
the option does not exist, returns `default`. If `default` is
not provided raises a `ConfigError`.

#### _ConfigHelper.has_section(section_name)_
...
#### _ConfigHelper.getsection(section_name)_
...
#### _Server.lookup_component(component_name, default=Sentinel)_
...
#### _Server.load_component(config, component_name, default=Sentinel)_
...
#### _Server.register_endpoint(uri, request_methods, callback, transports=["http", "websocket", "mqtt"], wrap_result=True)_
...
#### _Server.register_event_handler(event, callback)_
...
#### _Server.send_event(event, \*args)_
...
#### _Server.register_notification(event_name, notify_name=None)_
...
#### _WebRequest.get(key, default=Sentinel)_
...
#### _WebRequest.get_str(key, default=Sentinel)_
...
#### _WebRequest.get_int(key, default=Sentinel)_
...
#### _WebRequest.get_float(key, default=Sentinel)_
...
#### _WebRequest.get_boolean(key, default=Sentinel)_
...
#### _MQTTClient.is_connected()_

Returns true if Moonraker is currently connected to the Broker, false
otherwise.

#### _MQTTClient.wait_connection(timeout=None)_
...
#### _MQTTClient.publish_topic(topic, payload=None, qos=None, retain=False)_
...
#### _MQTTClient.publish_topic_with_response(topic, response_topic, payload=None, qos=None, retain=False, timeout=None)_
...
#### _MQTTClient.subscribe_topic(topic, callback, qos=None)_
